...
# 4. vendor klasörünü sil ve sıfırdan kur (Eski uyumsuz dosyalar gitsin)
RUN rm -rf vendor composer.lock && composer install --optimize-autoloader --no-dev

# 5. Veritabanı ve İzinler
